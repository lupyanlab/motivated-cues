...
summarySEwithin <- function(data=NULL, measurevar, betweenvars=NULL, withinvars=NULL,
    ...
    datac <- summarySE(data, measureNormedVar, groupvars=c(betweenvars, withinvars), na.rm=na.rm,
                       conf.interval=conf.interval, .drop=.drop)

    dataNotNormed <- summarySE(data, measurevar, groupvars=c(betweenvars, withinvars), na.rm=na.rm,
                       conf.interval=conf.interval, .drop=.drop)
    ...
    datac[,measurevar] = dataNotNormed[,measurevar]
    return(datac)
}
